...
// Bootstrap u542fu52a8u914du7f6e
...
// Client u5ba2u6237u7aefu914du7f6e
type Client struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tenant        *Client_GRPC           `protobuf:"bytes,1,opt,name=tenant,proto3" json:"tenant,omitempty"` // u79dfu6237u670du52a1u5ba2u6237u7aef
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\x0emin_idle_conns\x18\t \x01(\x05R\fminIdleConns\"\x92\x01\n" +
	"\x06Client\x123\n" +
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 7: marketing.conf.Client.tenant:type_name -> marketing.conf.Client.GRPC
